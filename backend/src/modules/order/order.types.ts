import z from "zod";
import { acceptOrderSchema, cancelOrderSchema, orderDtoSchema, orderItemDtoSchema, orderStatsSchema, updateOrderStatusSchema } from "./order.schema";
...
export type CancelOrderResponse = ApiResponse<OrderDto>;
